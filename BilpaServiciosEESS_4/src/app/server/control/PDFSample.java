...
public class PDFSample {
	public static void main(String[] args) {
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("/home/juan/ITextTest.pdf"));
			document.open();
			...
			document.add(new Paragraph("Some more text on the first page with different color and font type.",			
					FontFactory.getFont(FontFactory.COURIER, value, Font.BOLD, new Color(255, 150, 200))));
