...
public class IUDialogoEliminarModeloTipoActivoGenerico extends DialogBox{
	...
	public IUDialogoEliminarModeloTipoActivoGenerico(boolean autoHide, IUGestionarModeloTipoActivoGenerico padre, GlassPopup glass, PopupCargando popUp, final ModeloActivoGenerico tipoActivoGenericoSeleccionado) {
		super(autoHide);
		this.glass = glass;
		this.popUp = popUp;
		this.padre = padre;
		...
		lblTituloDialTEliminar  = new Label("Seguro desea eliminar el modelo " + tipoActivoGenericoSeleccionado.getNombre() + "?");
	}
	...
	private void eliminar(ModeloActivoGenerico object) {
		popUp.show();
		ProyectoBilpa.greetingService.eliminarModeloActivoGenerico(object,new AsyncCallback<Boolean>() {
