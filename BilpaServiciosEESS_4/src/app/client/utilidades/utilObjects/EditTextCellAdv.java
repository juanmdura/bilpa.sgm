...
public class EditTextCellAdv extends AbstractEditableCell<String, EditTextCellAdv.ViewData> {
     ...
     */
    public EditTextCellAdv(SafeHtmlRenderer<String> renderer) {
